...
public class CrazyOptionals {
    ...
    /**
     * Returns account provided by {@link AccountProvider}. If no account is provided
     * it generates one using {@link Accounts}
     * Please note that additional account should not be generated if
     * {@link AccountProvider} returned one.
     *
     * @param accountProvider
